...
public class GameBoardView {
    ...
    public void refreshBoard() {
        ...
        for (int index = 0; index < 100; index++) {
            ...
            cellViews[row][col].updateCell(cells[row][col], index);
        }
    ...
    private void addTransportArrow(int fromIndex, int toIndex, Color color) {
        ...
        double startX = (fromScene.getMinX() + fromScene.getMaxX()) / 2 - overlayScene.getMinX();
        double startY = (fromScene.getMinY() + fromScene.getMaxY()) / 2 - overlayScene.getMinY();
        double endX = (toScene.getMinX() + toScene.getMaxX()) / 2 - overlayScene.getMinX();
        double endY = (toScene.getMinY() + toScene.getMaxY()) / 2 - overlayScene.getMinY();
