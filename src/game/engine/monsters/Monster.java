...
public abstract class Monster implements Comparable<Monster> {
	...
	private boolean PoweredUpActivated; // For momentum card
	...
	public void setPoweredUpActivated(boolean activated) {
		this.PoweredUpActivated = activated;
	}

	public boolean isPoweredUpActivated() {
		return PoweredUpActivated;
	}
